...
The new set of metadata is an xml RDF document in a format similar to an xml file generated by exiftool (see https://exiftool.org/) when analyzing a wav file. This master document includes at least 19 fields (listed below).
